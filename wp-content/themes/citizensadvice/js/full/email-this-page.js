...
$(function ($) {
    ...
    var errorTemplate = '<p class="highlight--error">Sorry there has been an error. Please ensure you have cookies turned on in your browser.</p>';
            ...
            .on('submit', 'form', function (e) {
                ...
                .then(
                    ...
                    function (req) {
                        ...
                        dialog.$content.html(errorTemplate);
                    }
                );
            });
